...
def preprocess_crime_data(SPD_file_name):
    ...
    """
    chunk = pd.read_csv(SPD_file_name, chunksize=1000, usecols=["Report Number", "Offense Start DateTime", "Report DateTime", "Offense Parent Group",
        "Offense Code", "Offense", "MCPP", "Longitude", "Latitude"])
    df = pd.concat(chunk)
